...
process.on("unhandledRejection", errorHandler);
 ...
 if (process.argv.length < 7){console.log(`Usage: node TZyoxC-C.js target time rate thread proxy.txt`); process.exit();}
 const headers = {};
...
const tips1 =[
 ...
 "TZyoxC Created in 2020, Friends Who Supported me: @TZyoxC"
];
